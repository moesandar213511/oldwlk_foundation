                    ...
                    <div class="col-md-4 col-sm-2">
                    	<div class="widget clearfix">
                    		...
                    		<ul>
                    			...
                    			<li><a href="#"><img src="{{asset('upload/twitter.png')}}" width="30px" height="30px" alt=""></a></li>
					 ...
					 <div class="col-md-4 col-sm-2">
                    	<div class="widget clearfix">
                    		...
                    		<ul>
                    			<li><i class="fa fa-whatsapp">&nbsp;&nbsp;{{$office->phone}}</i></li>
                    			<li><i class="fa fa-envelope">&nbsp;&nbsp;{{$office->email}}</i></li>
                    			<li><i class="fa fa-fax">&nbsp;&nbsp;{{$office->address}}</i></li>
                    		</ul>
                    	</div><!-- end widget -->
					</div><!-- end col -->
				</div>
